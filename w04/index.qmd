...
|:- |:- |:- |:- |:-:|
| **Lecture** | 12:30pm | 1:00pm | <a href="#data-gathering">Data Gathering &rarr;</a> | <a href="./recording-w03-1.html" target="_blank"><i class="bi bi-film"></i></a> |
| | 1:00pm | 1:30pm | <a href="#web-scraping">Web Scraping &rarr;</a> | <a href="./recording-w03-2.html" target="_blank"><i class="bi bi-film"></i></a> |
| | 1:30pm | 1:45pm | <a href="#apis">APIs &rarr;</a> | <a href="https://jfh.georgetown.domains/dsan5000/slides-and-labs/_site/content/slides/html-css-basics/presentation.html#/html-and-css" target="_blank"><i class="bi bi-film"></i></a> |
| | 1:45pm | 2:00pm | Quiz | | |
| **Break!** | 2:00pm | 2:10pm | | | |
| **Lab** | 2:10pm | 2:50pm | <a href="#lab-demonstrations">Lab Demonstrations &rarr;</a> | <a href="./recording-w03-4.html" target="_blank"><i class="bi bi-film"></i></a> |
| | 2:50pm | 3:00pm | <a href="#lab-assignment-overview">Lab Assignment Overview &rarr;</a> | <a href="./recording-w03-5.html" target="_blank"><i class="bi bi-film"></i></a> |

: {tbl-colwidths="[14,12,12,50,12]"} 

## Overview {.smaller}

* Week-04 topics: Data collections, scrapping, and, APIs
* Introduction to common data structures and format:
* Record, Transaction, Time-series, Network data, Text-data, Image-data
* Structure/un-structured and Intensive vs extensive data
* Quick look at common formats: CSV, JSON, XML, etc
* URL queries, web-scraping, legality and website Terms of Service
* Introduction of Beautiful soup
* (Good reference) https://realpython.com/python-web-scraping-practical-introduction/
* API fundamentals, APIs in R/python, (examples, google scholar wikipedia, news api, etc)
* What is an API?
* Types of APIs (e.g. REST)
* API Authentication and Key Management
* Making API Requests (GET, POST, PUT, DELETE)
* Using an API in R and Py to collect text data (with examples and code)
* Other methods for collecting data; Government data, Kaggle, etc
...
Install `PyGithub` using the following terminal/shell command:

```bash
pip install PyGithub
```

[[Documentation]](https://github.com/PyGithub/PyGithub){target="_blank"} 

:::

The `PyGithub` library can handle this authentication process for you. Example: <a href="https://github.com/jpowerj/private-repo-test/" target="_blank">this private repo</a> in my account does **not** show up unless the request is **authenticated** (via a Personal Access Token)[^security]:
...
[^security]: Your code should **never** contain authentication info, especially when using GitHub. In this case, I created an OS **environment variable** called `GITHUB_TOKEN` containing my Personal Access Token, which I then load using [Python-Dotenv](https://github.com/theskumar/python-dotenv){target="_blank"} and provide to `PyGithub`.
